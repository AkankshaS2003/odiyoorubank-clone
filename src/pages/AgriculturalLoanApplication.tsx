        ...
        <div className="bg-white p-8 md:p-12 shadow-2xl shadow-slate-200 border border-slate-300 print:shadow-none print:border-none print:p-2">
          ...
          <div className="flex items-start justify-between border-b-2 border-[#0F4C81] pb-4 mb-8">
            ...
            <div className="flex-grow px-4 text-[#ED7F1E]">
              ...
              <div className="flex justify-end items-center gap-2"><span>Branch:</span> <input type="text" value="Main Branch" readOnly className="w-24 border-b border-slate-400 outline-none print:border-slate-800 bg-transparent text-[#0F4C81] capitalize text-right font-medium"/></div>
              <div className="flex justify-end items-center gap-2"><span>App No:</span> <input type="text" value={formData.applicationNo} readOnly className="w-24 border-b border-slate-400 outline-none print:border-slate-800 bg-transparent text-[#0F4C81] capitalize text-right font-medium"/></div>
              <div className="flex justify-end items-center gap-2"><span>Date:</span> <input type="text" value={formData.date} readOnly className="w-24 border-b border-slate-400 outline-none print:border-slate-800 bg-transparent text-[#0F4C81] capitalize text-right font-medium"/></div>
            </div>
          </div>
