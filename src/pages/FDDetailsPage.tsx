      ...
      <div className="max-w-[850px] mx-auto px-4 sm:px-6 lg:px-8 print:px-0 print:max-w-none">
        ...
        <div className="bg-white p-8 md:p-12 shadow-2xl shadow-slate-200 border border-slate-100 rounded-3xl print:rounded-none print:shadow-none print:border-none print:p-2">
          ...
          <div className="flex items-center justify-center border-b-4 border-[#0F4C81] pb-6 mb-8">
            <div className="w-full text-[#ED7F1E]">
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl font-black text-slate-800 uppercase tracking-wide">Fixed Deposit Account Details</h2>
            <div className="inline-flex items-center gap-1.5 mt-3 px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-black uppercase tracking-wider">
          ...
          <div className="mt-8 pt-8 border-t border-slate-200 flex flex-wrap gap-4 justify-center print:hidden">
            <button className="px-4 py-2 border border-slate-300 rounded text-xs font-bold text-slate-600 hover:bg-slate-50 transition-colors">FD Renewal History</button>
            <button className="px-4 py-2 border border-slate-300 rounded text-xs font-bold text-slate-600 hover:bg-slate-50 transition-colors">Interest Payout History</button>
            <button className="px-4 py-2 border border-slate-300 rounded text-xs font-bold text-slate-600 hover:bg-slate-50 transition-colors">Loan Against FD Eligibility</button>
            <button className="px-4 py-2 bg-rose-50 border border-rose-200 rounded text-xs font-bold text-rose-600 hover:bg-rose-100 transition-colors">Request Premature Closure</button>
          </div>
