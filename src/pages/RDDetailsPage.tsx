...
export const RDDetailsPage = ({ appId, setCurrentTab }: { appId: string, setCurrentTab: (tab: string) => void }) => {
  ...
  const interestRate = systemSettings?.rdRate || 7.75;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="border border-t-0 border-[#0F4C81] p-5 rounded-b-lg space-y-1">
                ...
                <InfoRow label="Aadhaar Number" value={(rdData.formData?.app1Aadhaar || user?.aadharNumber) ? 'XXXX XXXX ' + String(rdData.formData?.app1Aadhaar || user?.aadharNumber).slice(-4) : 'XXXX XXXX 1234'} />
                <InfoRow label="PAN Number" value={(rdData.formData?.app1Pan || user?.panNumber) ? 'XXXXXX' + String(rdData.formData?.app1Pan || user?.panNumber).slice(-4) : 'XXXXXX1234'} />
              ...
              <div className="text-sm font-medium text-slate-800 leading-loose max-w-2xl mx-auto mb-12 text-justify italic">
                ...
                <div className="text-center w-40">
                  <div className="h-16 flex items-end justify-center mb-1">
                    {rdData.images?.signature ? (
                      <img src={rdData.images.signature} alt="Depositor Signature" className="max-h-16 object-contain mix-blend-multiply" />
                    ) : (
