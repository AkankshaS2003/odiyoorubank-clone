...
export const Management: React.FC<ManagementProps> = ({ setCurrentTab }) => {
  ...
  const directors: Director[] = [
    ...
    },
    {
      ...
      role: 'Vice President',
      image: '/gallery/vicepresident.png',
